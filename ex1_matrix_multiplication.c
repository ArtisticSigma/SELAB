// ============================================================
// Ex No : 01
// Title : Matrix Multiplication - Causes of Failure
// ============================================================
...
// Test Case 2 (Failure - incompatible dimensions):
//   Input:  2 3   (rows/cols of A)
//           2 1   (rows/cols of B)
//   Output: Test Case 2: Matrix Multiplication is not possible
//           The columns of A Matrix are not equal to rows of B Matrix
//           Case 2: Failure
//
// Test Case 1 (Success):
//   Input:  3 2   (rows/cols of A)
//           2 2   (rows/cols of B)
//           A: 1 5 / 3 4 / 7 1
//           B: 2 3 / 4 1
//   Output: Test Case 1: Matrix Multiplication can be done
//           Case 1: Success
//           22  8
//           22  13
//           18  22
//
// Test Case 3 (Failure - non-integer input):
//   Input:  2 2 / 2 3
//           A: 1 2 / 1.5 2
//   Output: Test Case 3: Matrix Multiplication is not possible
